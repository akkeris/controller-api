...
async function create(pg_pool, app_uuid, app_name, space_name, space_tags, org, addon, req) {
...
async function http_create(pg_pool, req, res, regex) {
  ...
  return httph.created_response(res, JSON.stringify(await create(pg_pool, app.app_uuid, app.app_name, app.space_name, '', app.org_name, payload.addon, req)))
}
