...
async function attach(pg_pool, app, addon_plan, service, owner) {
  ...
  await insert_service_attachment(pg_pool, [service_attachment_uuid, service_attachment_name, service.service, app.id, owner && owner.id === app.id ? true : false, created_updated, created_updated]);
