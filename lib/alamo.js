...
async function create_osb_bindings(pg_pool, service_id, plan_id, addon_id, space_name, app_name) {
  return await alamo_fetch('put', `${await get_region_api_by_space(pg_pool, space_name)}/v2/service_instances/${addon_id}/service_bindings/${app_name}-${space_name}`, {service_id, plan_id});
}
