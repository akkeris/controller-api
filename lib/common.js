...
async function trigger_action(pg_pool, app_key, action_key, triggered_by) {
  ...
  return insert_action_run(pg_pool, action_run_params);
}
...
async function notify_actions(pg_pool, app_uuid, type, username) {
  ...
  actions.forEach((action) => {
    trigger_action(pg_pool, app_uuid, action.action, username)
