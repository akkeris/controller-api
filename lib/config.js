...
let config = {
  ...
  akkeris_app_controller_url:http_help.clean_forward_slash(process.env.AKKERIS_APP_CONTROLLER_URL || process.env.ALAMO_APP_CONTROLLER_URL),
...
if(process.env.ALAMO_APP_CONTROLLER_URL) {
