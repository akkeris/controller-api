...
// public
async function create(pg_pool, app_uuid, app_name, space_name, space_tags, org_name, type, size, quantity, command, port, healthcheck, remove_health_check, user) {
  ...
  formation = await create_dyno(pg_pool, app_uuid, app_name, space_name, type, command, quantity, size, port, healthcheck, user);
  if (type !== 'web') {
    setTimeout(() => {
