...
async function oneoff_update(pg_pool, app_uuid, space_name, formation_uuid, size, command, options) {
  ...
  await update_oneoff_formation(pg_pool, [formation_uuid, payload.size, payload.command, payload.options]);
}
