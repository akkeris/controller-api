...
const availableHooks = [
  {
    type: 'action_run_finished',
    description: 'Fired when an action run is finished. Fires once per run.',
  },
  {
    type: 'action_run_started',
    description: 'Fired when an action run is started. Fires at most once per run, but might not fire if the run takes less than 10 seconds',
  },
  {
    type: 'addon_change',
