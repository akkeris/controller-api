...
async function create_pipeline_coupling(pg_pool, app_uuid, app_name, space_name, org_uuid, pipeline, stage) {
  ...
  // TODO: place required status checks?
...
async function http_update_pipeline_coupling(pg_pool, req, res, regex) {
  ...
  // TODO: the only field that's updatable is the required_status_checks.
...
async function http_create_pipeline_promotion(pg_pool, req, res, regex) {
  ...
  // TODO: Add checks for pipeline promotions.
  // do we check the target apps required_status_checks or the source apps ?...
