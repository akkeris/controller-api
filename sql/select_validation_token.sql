select 
  auto_builds.auto_build, auto_builds.app, auto_builds.repo, auto_builds.branch, auto_builds.auto_deploy, auto_builds.validation_token,
  authorizations.user_id, authorizations.username, authorizations.token,
  organizations.name org, apps.name appname, spaces.name spacename
from
  auto_builds
