...
describe('spaces: ensure we can pull and list spaces', function () {
  ...
  it('covers not allowing duplicate spaces to be created', (done) => {
    httph.request(
      ...
      alamo_headers,
      JSON.stringify({ name: 'default', description: 'FFFUUUUGGGAAZZIII!!!' }),
      (err, data) => {
  ...
  it('covers not allowing protected spaces to be created', (done) => {
    httph.request(
      ...
      'http://localhost:5000/spaces',
      alamo_headers,
      JSON.stringify({ name: 'kube-system', description: 'FFFUUUUGGGAAZZIII!!!' }),
      (err, data) => {
        expect(err).to.be.an('object');
        expect(data).to.be.null;
        done();
  ...
  it('covers not allowing protected spaces to be created', (done) => {
    httph.request(
      ...
      'http://localhost:5000/spaces',
      alamo_headers,
      JSON.stringify({ name: 'k2-poc', description: 'FFFUUUUGGGAAZZIII!!!' }),
      (err, data) => {
        expect(err).to.be.an('object');
        expect(data).to.be.null;
        done();
  ...
  it('covers not allowing protected spaces to be created', (done) => {
    httph.request(
      ...
      'http://localhost:5000/spaces',
      alamo_headers,
      JSON.stringify({ name: 'kube-public', description: 'FFFUUUUGGGAAZZIII!!!' }),
      (err, data) => {
        expect(err).to.be.an('object');
        expect(data).to.be.null;
        done();
  ...
  it('covers checking spaces name', (done) => {
    httph.request(
      ...
      'http://localhost:5000/spaces',
      alamo_headers,
      JSON.stringify({ name: '!!! YEAH !!!', description: 'FFFUUUUGGGAAZZIII!!!' }),
      (err, data) => {
        expect(err).to.be.an('object');
        expect(data).to.be.null;
        done();
  ...
  it('partially covers creating spaces', (done) => {
    httph.request(
      ...
      'http://localhost:5000/spaces',
      alamo_headers,
      JSON.stringify({ name: 'fugazi', description: 'FFFUUUUGGGAAZZIII!!!' }),
      (err, data) => {
        if (err) {
          console.error(err);
        }
  ...
  it('partially covers creating internal spaces', (done) => {
    httph.request(
      ...
      'http://localhost:5000/spaces',
      alamo_headers,
      JSON.stringify({ name: 'fugazi', compliance: ['internal'], description: 'FFFUUUUGGGAAZZIII!!!' }),
      (err, data) => {
        if (err) {
          console.error(err);
        }
